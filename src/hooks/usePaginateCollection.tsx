// God bless this guy: https://github.com/ImJustChew/usePaginateCollection
import {
    CollectionReference,
    DocumentData,
    endAt,
...
import { useIsFirestoreRefEqual } from '../utils/firestoreUtil';
...
const usePaginateCollection = <DocType extends DocumentData = DocumentData>(colRef: CollectionReference<DocType>, {
    ...
    async function getDocuments() {
        ...
        const snapshots = await getDocs(query(ref.current, ...queryConstraints, orderBy(orderKey, direction), limit(pageLimit)))
    ...
    async function loadMore() {
        ...
        const snapshots = await getDocs(query(ref.current,
            ...queryConstraints,
        ...
        const listener = onSnapshot(query(ref.current,
            ...queryConstraints,
